...
export const mockPressReleases: PressRelease[] = [
  ...
  },
  {
    ...
    publishedAt: getRecentDate(7), // 7 days ago
    companyId: "3",
    aiAnalysis: {
      summary:
  ...
  },
  {
    ...
    sourceUrl:
      "https://www.prnewswire.com/news-releases/addepar-acquires-wealthtech-startup-for-500-million-to-expand-portfolio-analytics-302345681.html",
    publishedAt: getRecentDate(10), // 10 days ago
    companyId: "4",
    aiAnalysis: {
      summary:
    ...
    createdAt: "2024-01-08T11:50:00Z",
  },
  {
    id: "5",
    ...
    sourceUrl:
      "https://www.prnewswire.com/news-releases/subscribe-technologies-raises-150-million-series-c-to-accelerate-global-expansion-302345682.html",
    publishedAt: getRecentDate(13), // 13 days ago
    companyId: "5",
    aiAnalysis: {
      summary:
  ...
  // Additional press releases for variety
  {
    id: "6",
    ...
    sourceUrl:
      "https://www.prnewswire.com/news-releases/blackstone-real-estate-income-trust-declares-monthly-distribution-of-0-12-per-share-302345683.html",
    publishedAt: getRecentDate(15), // 15 days ago
    companyId: "1",
    aiAnalysis: {
      summary:
  ...
  },
  {
    ...
    publishedAt: getRecentDate(20), // 20 days ago
    companyId: "2",
    aiAnalysis: {
      summary:
